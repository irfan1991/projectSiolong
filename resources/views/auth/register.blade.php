            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <div class="input-icon left">
                        ...
                        <input class="m-wrap placeholder-no-fix" type="text" placeholder="Email" id="email" name="email" value="{{ old('email') }}"/>
                    </div>
                </div>
            </div>
            <div class="control-group">
            ...
            <div class="control-group">
                <div class="controls">
                    <label class="checkbox">
                     <input type="checkbox" name="tnc"/> I agree to the <a href="{{url('privasi')}}">Terms of Service</a> and <a href="{{url('kebijakan')}}">Privacy Policy</a>
                    </label>  
