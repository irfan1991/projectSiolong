...
<!-- page content -->
      <div class="right_col" role="main">
        ...
        <br />
     <div class="panel panel-dafault"><h3>Table Kategori <small><a href="{{ route('kategori.create') }}" class="btn btn-warning 
...
<p align="center"><a href="{{ url('kategori') }}">Lihat semua data <i class="fa fa-arrow-left"></i></a></p>
